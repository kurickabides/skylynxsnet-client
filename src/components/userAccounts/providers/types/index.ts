// This is our Global Interface app types file all type here are core interfaces used for core components and services
// Move Sub Components out to sub comp files and then import main interfaces only 
...
export type PlaidLinkPropTypes = {
...
export interface IPlaid {
  ...
  create: (config: PlaidLinkOptions) => IPlaid;
  destroy: () => void;
}
...
export interface FB_AuthLoginReq {
  name: string;
  address: string;
}
...
//FireBase Auth Login Request
export interface FB_AuthLoginResponse {
